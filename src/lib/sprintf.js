...
//------------------------------------------------------------------------------
function doFormat(substring, valueIndex, flags, minWidth, precision, type) {
	...
	switch (type) {
		case 's':
			return formatString(`${value}`, leftJustify, minWidth, precision, zeroPad, customPadChar);
		case 'c':
...
//------------------------------------------------------------------------------
export default function sprintf(...a) {
